...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// groupBox4
			// 
			this->groupBox4->Controls->Add(this->lblAvailableCompounds);
			...
			// 
			// lblAvailableCompounds
			// 
			this->lblAvailableCompounds->Location = System::Drawing::Point(9, 25);
			this->lblAvailableCompounds->Name = L"lblAvailableCompounds";
			this->lblAvailableCompounds->Size = System::Drawing::Size(282, 110);
			this->lblAvailableCompounds->TabIndex = 0;
